...
<footer class="bg-dark text-center text-white">
    ...
    <div class="container p-4">
      ...
      <section class="mb-4">
        <p>
          Aplicación de ejemplo en plataforma laravel 10 Rest Api, vue 3, Mysql.
        </p>
      </section>
      <!-- Section: Text -->
    </div>
